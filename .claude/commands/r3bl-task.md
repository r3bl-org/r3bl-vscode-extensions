...
- The filename should start with "task\_" prefix, so if $2 is "foo" or "foo.md",
...
- Make sure the task/$2 file exists (with task\_ prefix), and if it does not then tell the user
