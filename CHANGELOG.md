...
- [Change Log](#change-log)
    - [[2026-09-04] - Dynamic Status Bar Icons for Rust Targets](#2026-09-04---dynamic-status-bar-icons-for-rust-targets)
    ...
    - [[2026-07-28] - Git Diff Search Editor Enhancements and Label Cleanups](#2026-07-28---git-diff-search-editor-enhancements-and-label-cleanups)
        ...
        - [Changes](#changes-3)
    - [[2026-08-04] - Close Current Task Space Command](#2026-08-04---close-current-task-space-command)
        - [Package Versions](#package-versions-4)
        - [Changes](#changes-4)
    - [[2026-07-25] - R3BL Theme Dialog & Popup Borders Update](#2026-07-25---r3bl-theme-dialog--popup-borders-update)
        - [Package Versions](#package-versions-5)
        - [Changes](#changes-5)
    - [[2026-07-18] - R3BL 2026 Theme Editor Tab Update](#2026-07-18---r3bl-2026-theme-editor-tab-update)
        - [Package Versions](#package-versions-6)
        - [Changes](#changes-6)
    - [[2026-07-16] - R3BL 2026 Theme, Documentation Updates, and Color Fix](#2026-07-16---r3bl-2026-theme-documentation-updates-and-color-fix)
        - [Package Versions](#package-versions-7)
        - [Changes](#changes-7)
    - [[2026-07-21] - Peek View Colors Update for R3BL 2026 Theme](#2026-07-21---peek-view-colors-update-for-r3bl-2026-theme)
        - [Package Versions](#package-versions-8)
        - [Changes](#changes-8)
    - [[2026-06-24] - Rustdoc Link Reference Definition Auto-Insertion](#2026-06-24---rustdoc-link-reference-definition-auto-insertion)
        - [Package Versions](#package-versions-9)
        - [Changes](#changes-9)
    - [[2026-05-12] - Scroll Current Line to Top Feature](#2026-05-12---scroll-current-line-to-top-feature)
        - [Package Versions](#package-versions-10)
        - [Changes](#changes-10)
    - [[2026-04-03] - Extension Pack Metadata Update and Search Feature Discovery](#2026-04-03---extension-pack-metadata-update-and-search-feature-discovery)
        - [Package Versions](#package-versions-11)
        - [Changes](#changes-11)
    - [[2026-04-03] - README Documentation Refresh](#2026-04-03---readme-documentation-refresh)
        - [Package Versions](#package-versions-12)
        - [Changes](#changes-12)
    - [[2026-04-02] - Dashboard Workflow and Extension Stabilization](#2026-04-02---dashboard-workflow-and-extension-stabilization)
        - [Package Versions](#package-versions-13)
        - [Changes](#changes-13)
    - [[2026-03-30] - Multi-Agent Support for Task Management](#2026-03-30---multi-agent-support-for-task-management)
        - [Package Versions](#package-versions-14)
        - [Changes](#changes-14)
    - [[2026-03-30] - Git Diff Search Editor Refresh Support](#2026-03-30---git-diff-search-editor-refresh-support)
        - [Package Versions](#package-versions-15)
        - [Changes](#changes-15)
    - [[2026-03-27] - Fuzzy Search Documentation Overhaul](#2026-03-27---fuzzy-search-documentation-overhaul)
        - [Package Versions](#package-versions-16)
        - [Changes](#changes-16)
    - [[2026-03-27] - Extension Pack Documentation Overhaul](#2026-03-27---extension-pack-documentation-overhaul)
        - [Package Versions](#package-versions-17)
        - [Changes](#changes-17)
    - [[2026-03-27] - Git Diff Search Editor Commit Selection and Copy Selection Absolute Path Support](#2026-03-27---git-diff-search-editor-commit-selection-and-copy-selection-absolute-path-support)
        - [Package Versions](#package-versions-18)
        - [Changes](#changes-18)
    - [[2026-03-25] - Use Statement Folding Control](#2026-03-25---use-statement-folding-control)
        - [Package Versions](#package-versions-19)
        - [Changes](#changes-19)
    - [[2026-03-25] - Git Diff Search Editor](#2026-03-25---git-diff-search-editor)
        - [Package Versions](#package-versions-20)
        - [Changes](#changes-20)
    - [[2026-03-17] - Simplified Task Command Format](#2026-03-17---simplified-task-command-format)
        - [Package Versions](#package-versions-21)
        - [Changes](#changes-21)
    - [[2026-03-16] - Use Statement Folding and Unit Test Infrastructure](#2026-03-16---use-statement-folding-and-unit-test-infrastructure)
        - [Package Versions](#package-versions-22)
        - [Changes](#changes-22)
    - [[2026-03-11] - Rustdoc Auto-Fold Default Changed to Disabled](#2026-03-11---rustdoc-auto-fold-default-changed-to-disabled)
        - [Package Versions](#package-versions-23)
        - [Changes](#changes-23)
    - [[2026-03-07] - Generalize "Claude Code" references to "AI coding agent"](#2026-03-07---generalize-claude-code-references-to-ai-coding-agent)
        - [Package Versions](#package-versions-24)
        - [Changes](#changes-24)
    - [[2026-03-07] - Rustdoc Navigator: Document keybinding customization](#2026-03-07---rustdoc-navigator-document-keybinding-customization)
        - [Package Versions](#package-versions-25)
        - [Changes](#changes-25)
    - [[2026-03-07] - Rustdoc Navigator: TOP, BOTTOM, and LINK REF DEFS Navigation](#2026-03-07---rustdoc-navigator-top-bottom-and-link-ref-defs-navigation)
        - [Package Versions](#package-versions-26)
        - [Changes](#changes-26)
    - [[2026-03-03] - Rustdoc Structure Navigator](#2026-03-03---rustdoc-structure-navigator)
        - [Package Versions](#package-versions-27)
        - [Changes](#changes-27)
    - [[2026-02-11] - Brighter Comment Color](#2026-02-11---brighter-comment-color)
        - [Package Versions](#package-versions-28)
        - [Changes](#changes-28)
    ...
    - [[2025-12-24] - Rustdoc Folding and Task File Naming Improvements](#2025-12-24---rustdoc-folding-and-task-file-naming-improvements)
        - [Package Versions](#package-versions-32)
        - [Changes](#changes-32)
    - [[2025-12-12] - Task File Discovery and Delete Dialog Improvements](#2025-12-12---task-file-discovery-and-delete-dialog-improvements)
        - [Package Versions](#package-versions-33)
        - [Changes](#changes-33)
    - [[2025-12-08] - Multi-IDE Task Space Support and Documentation](#2025-12-08---multi-ide-task-space-support-and-documentation)
        - [Package Versions](#package-versions-34)
        - [Changes](#changes-34)
    - [[2025-11-29] - Diff View Color Change](#2025-11-29---diff-view-color-change)
        - [Package Versions](#package-versions-35)
        - [Changes](#changes-35)
    - [[2025-11-26] - Documentation Update](#2025-11-26---documentation-update)
        - [Package Versions](#package-versions-36)
        - [Changes](#changes-36)
    - [[2025-11-26] - Multi-Instance Sync and Architecture Improvements](#2025-11-26---multi-instance-sync-and-architecture-improvements)
        - [Package Versions](#package-versions-37)
        - [Changes](#changes-37)
    - [[2025-11-21] - Fixed CHANGELOG Links in Marketplace Listings](#2025-11-21---fixed-changelog-links-in-marketplace-listings)
        - [Package Versions](#package-versions-38)
        - [Changes](#changes-38)
    - [[2025-11-21] - Documentation Updates and Branding Improvements](#2025-11-21---documentation-updates-and-branding-improvements)
        - [Package Versions](#package-versions-39)
        - [Changes](#changes-39)
    - [[2025-11-21] - Task Management Bug Fix](#2025-11-21---task-management-bug-fix)
        - [Package Versions](#package-versions-40)
        - [Changes](#changes-40)
    - [[2025-11-20] - Task Management Storage Architecture Improvement](#2025-11-20---task-management-storage-architecture-improvement)
        - [Package Versions](#package-versions-41)
        - [Changes](#changes-41)
    - [[2025-11-20] - Fuzzy Search Improvements and Notification Auto-Dismiss](#2025-11-20---fuzzy-search-improvements-and-notification-auto-dismiss)
        - [Package Versions](#package-versions-42)
        - [Changes](#changes-42)
    - [[2025-11-19] - Theme Warning Colors and Debounced Flycheck Feature](#2025-11-19---theme-warning-colors-and-debounced-flycheck-feature)
        - [Package Versions](#package-versions-43)
        - [Changes](#changes-43)
    - [[2025-11-18] - Copy Selection Path and Range: Republish](#2025-11-18---copy-selection-path-and-range-republish)
        - [Package Versions](#package-versions-44)
        - [Changes](#changes-44)
    - [[2025-11-18] - Task Management: Pinned Tabs, Tab Ordering, and Diff-Based Sync](#2025-11-18---task-management-pinned-tabs-tab-ordering-and-diff-based-sync)
        - [Package Versions](#package-versions-45)
        - [Changes](#changes-45)
    - [[2025-11-18] - Documentation and Screenshot Updates](#2025-11-18---documentation-and-screenshot-updates)
        - [Package Versions](#package-versions-46)
        - [Changes](#changes-46)
    - [[2025-11-17] - Extension Pack Documentation Update](#2025-11-17---extension-pack-documentation-update)
        - [Package Versions](#package-versions-47)
        - [Changes](#changes-47)
    - [[2025-11-17] - Theme and Semantic Configuration Integration](#2025-11-17---theme-and-semantic-configuration-integration)
        - [Package Versions](#package-versions-48)
        - [Changes](#changes-48)
    - [[2025-11-17] - Marketplace Metadata Improvements](#2025-11-17---marketplace-metadata-improvements)
        - [Package Versions](#package-versions-49)
        - [Changes](#changes-49)
    - [[2025-11-17] - Claude Code Integration for Task Management](#2025-11-17---claude-code-integration-for-task-management)
        - [Package Versions](#package-versions-50)
        - [Changes](#changes-50)
    - [[2025-11-17] - Task Management Enhancement](#2025-11-17---task-management-enhancement)
        - [Package Versions](#package-versions-51)
        - [Changes](#changes-51)
    - [[2025-11-16] - Auto Insert Copyright Bug Fix](#2025-11-16---auto-insert-copyright-bug-fix)
        - [Package Versions](#package-versions-52)
        - [Changes](#changes-52)
    - [[2025-11-16] - New Extension: R3BL Fuzzy Search](#2025-11-16---new-extension-r3bl-fuzzy-search)
        - [Package Versions](#package-versions-53)
        - [Changes](#changes-53)
    - [[2025-11-14] - Sublime Merge Color Integration](#2025-11-14---sublime-merge-color-integration)
        - [Package Versions](#package-versions-54)
        - [Changes](#changes-54)
    - [[2026-04-02] - Dashboard Workflow Major Release](#2026-04-02---dashboard-workflow-major-release)
        - [Package Versions](#package-versions-55)
        - [Changes](#changes-55)
        - [Package Versions](#package-versions-56)
        - [Changes](#changes-56)
    - [[2025-09-08] - Theme Color Refinements](#2025-09-08---theme-color-refinements)
        - [Package Versions](#package-versions-57)
        - [Changes](#changes-57)
    - [[2025-01-29] - Semantic Configuration Enhancement](#2025-01-29---semantic-configuration-enhancement)
        - [Package Versions](#package-versions-58)
        - [Changes](#changes-58)
    - [[2025-01-20] - Copyright and Theme Updates](#2025-01-20---copyright-and-theme-updates)
        - [Package Versions](#package-versions-59)
        - [Changes](#changes-59)
    - [[2025-01-12] - New Extensions Added](#2025-01-12---new-extensions-added)
        - [Package Versions](#package-versions-60)
        - [Changes](#changes-60)
        - [Infrastructure](#infrastructure)
    - [[2024-12-04] - Initial Release](#2024-12-04---initial-release)
        - [Package Versions](#package-versions-61)
        - [Changes](#changes-61)
...
## [2026-09-04] - Dynamic Status Bar Icons for Rust Targets

### Package Versions

- **R3BL Semantic Configuration**: 1.2.15 → 1.2.16
- **R3BL Extension Pack**: 1.3.28 → 1.3.29

### Changes

- **R3BL Semantic Configuration 1.2.16**: Dynamic status bar icons & project-scoped safety
    - Added dynamic platform icons for the `rust-analyzer` status bar item:
        - 🍎 Apple / macOS targets (`apple`, `darwin`)
        - 🐧 Linux targets (`linux`)
        - 🪟 Windows targets (`windows`)
        - 🌐 WebAssembly targets (`wasm`)
        - `$(chip)` Host / Default / unmapped targets
    - Enforced **strictly project-scoped** configuration: target selection writes
      exclusively to `.vscode/settings.json` and never pollutes global User settings.
    - Added workspace guard: switching targets requires an open project folder/workspace
      to prevent unintentional machine-wide changes.
    - Multi-scope cleanup on reset: selecting Host / Default clears all scopes
      (WorkspaceFolder, Workspace, and legacy Global) so stale global settings cannot
      shadow native host compilation.
    - Added comprehensive unit tests for `getTargetIcon`, `hasOpenWorkspace`, and scope
      clearing.

- **R3BL Extension Pack 1.3.29**: Updated dependencies and documentation
    - Updated `r3bl-semantic-config` dependency to 1.2.16.
    - Updated documentation for dynamic target status bar icons and project-scoped safety.
...
- **R3BL Opened Editors**: Initial Release → 1.0.0
- **R3BL Extension Pack**: 1.3.26 → 1.3.27

### Changes

- **R3BL Opened Editors 1.0.0**: Initial release of high-speed opened editors switcher
    - Added `r3bl-opened-editors.openedEditors` command to trigger searchable QuickPick
      list of all open editors across editor groups.
    - Added `r3bl-opened-editors.focusOpenEditorsView` command to focus the vertical Open
      Editors sidebar panel.
    - Added default keybindings for `Alt+E` (Linux/Windows) and `Cmd+E` (macOS).
    - Zero external runtime npm dependencies; ultra-lightweight (1.5 KB bundle).

- **R3BL Extension Pack 1.3.27**: Added R3BL Opened Editors to extension pack
    - Added `R3BL.r3bl-opened-editors` to `extensionPack` dependency list.
    - Updated documentation and shortcut guides for the complete R3BL suite.
...
- **R3BL Copy Selection Path and Range**: 1.3.4 → 1.4.0
- **R3BL Extension Pack**: 1.2.7 → 1.2.9

### Changes

- **R3BL Copy Selection Path and Range 1.4.0**: Absolute path support
    - When copying a path for a file outside of the VS Code workspace, the extension now
      provides the full absolute path instead of an error message.
    - Maintains AI-agent compatible formatting (`@` prefix and line ranges) for absolute
      paths.
    - Ensures consistent forward-slash normalization for all paths.

- **R3BL Fuzzy Search 1.3.0**: Recent commit selection in Git Diff Search Editor ... -
  Added a QuickPick menu when running the Git Diff Search Editor command - Choose between
  "Uncommitted Changes" or a list of recent commits - Configurable history limit via
  `r3blFuzzySearch.commitHistoryLimit` (default 10) - Full multi-root workspace support
  (aggregated commits from all repositories) - Unified Search Editor format for commit
  diffs (using `git show`) - Automatically handles merge commits correctly with
  `--first-parent` - Renamed command to "R3BL Fuzzy Search: Git Diff Search Editor"

## [2026-03-25] - Use Statement Folding Control

### Package Versions

- **R3BL Semantic Configuration**: 1.2.4 → 1.2.5
- **R3BL Extension Pack**: 1.2.6 → 1.2.7

### Changes

- **R3BL Semantic Configuration 1.2.5**: Added setting to control `use` statement folding
    - New setting `r3bl-semantic-config.autoFoldUseStatementsOnOpen` (boolean, default:
      `false`)
    - When `true`, automatically folds all Rust `use` statements at the top of a file upon
      opening.
    - Provides explicit user control over whether `use` statements are auto-folded.
    - Addresses user feedback regarding unwanted auto-collapsing of `use` statements when
      `editor.foldingStrategy: "auto"` is active.
    - The folding range provider for `use` statements is always registered, so manual
      fold/unfold is always available regardless of this setting.
    - Detects conflicting `editor.foldingImportsByDefault: true` setting and shows a
      one-time warning with a link to open settings.
    - Added recommended settings section to README.
...
- **R3BL Task Management**: 1.2.3 → 1.2.4
- **R3BL Extension Pack**: 1.1.5 → 1.1.6

### Changes

- **R3BL Task Management 1.2.4**: Improved `/r3bl-task done` command flexibility
    - The "done" command now offers two options instead of requiring the VS Code
      extension:
        - **Option A**: Use VS Code extension (recommended if you have a task space) -
          automatic archiving and cleanup
        - **Option B**: Move file directly - Claude Code moves the file to `task/done/`
          immediately
...
- **R3BL Semantic Configuration**: 1.1.7 → 1.1.8
- **R3BL Extension Pack**: 1.1.4 → 1.1.5

### Changes

- **R3BL Semantic Configuration 1.1.8**: Improved rustdoc auto-fold behavior
    - Fixed race condition when switching tabs rapidly
    - Auto-fold now silent (no status bar messages) - manual fold still shows feedback
    - Cursor and viewport position preserved when auto-folding
    - Removed `autoFoldDelayMs` setting - now uses purpose-specific delays internally:
        - 50ms for tab switching (allows VSCode to restore cursor position)
        - 100ms for startup (allows editor to initialize)
    - Multi-cursor selection approach for faster, smoother folding
    - Only folds rustdoc blocks (`///` and `//!`), not impl blocks or other code
