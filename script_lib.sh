...
get_all_versions() {
    ...
    OPENED_EDITORS_VERSION=$(get_version "./packages/r3bl-opened-editors/package.json")
    ...
    echo "  • R3BL Opened Editors: ${OPENED_EDITORS_VERSION}"
...
print_built_extensions() {
    ...
    echo "  • packages/r3bl-opened-editors/r3bl-opened-editors-${OPENED_EDITORS_VERSION}.vsix"
